    ...
    <Wrapper>
      <div className="flex items-center justify-between h-[100px] relative z-50">
        ...
        <div className="flex gap-10 text-white items-center justify-between ">
          ...
          {/* play   */}
          <div className=" backdrop-blur-sm px-3 h-[40px] relative bg-black/[.5] rounded-[5px] pt-2">
            <div className="flex items-center gap-3 ]">
              ...
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-5 h-5 cursor-pointer active:scale-95"
              ...
              <svg
                ...
                onClick={() => setAudioVolumeController(!audioVolumeController)}
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
